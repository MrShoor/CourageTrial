  ...
  begin
      ...
      begin
        if FEmptyCells <> nil then
          FEmptyCells := FEmptyCells.Union( GetObservablePointSet(nil, FEmptyCells) );
...
begin
  ...
  gvDebugPoints := FEmptyCells.ToIArray();
end;
